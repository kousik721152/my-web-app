...
export default (() => {
	return <Theme theme={theme}>
		...
		import  from '@quarkly/components';
		<Box
			display="flex"
		...
		>
			{"  "}
			<Image src="images/logo.png" alt="Your Logo" width="150px" margin="0 0 20px 0" />
			{"  "}
			<Text fontFamily="sans-serif" fontSize="24px" fontWeight="bold" color="#333">
				{"    "}Welcome to My App{"\n  "}
			</Text>
		</Box>
		// Example using Quarkly's responsive props
		<Box padding="20px" md-padding="30px" lg-padding="40px">
			{"  "}
		</Box>
		import{" "}{" "}from '@quarkly/components';
		<Button>
